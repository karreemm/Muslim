...
export const RenderQuranText = (surahData: any, fontSize: number, lineHeight: number, SNameAr: string | undefined, SNameEn: string | undefined, SNumber: number | string ) => {
  ...
  return (
    <div dir='rtl' className='flex flex-col items-center'>
      ...
      <div id="scrollable-div" ref={containerRef} className=' bg-white text-black shadow-md rounded-lg px-4 py-2 mt-5 md:mt-10 ayah-container max-w-[1200px] max-h-[300px] overflow-y-auto flex flex-wrap'>
        {ayahs.map(ayah => (
          <div
            key={ayah.number}
