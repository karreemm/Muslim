...
import { getHadith } from "./GetHadith";
...
export default function SingleHadith({ hadithNumber, bookId }: { hadithNumber: number, bookId: string }) {

    const { language } = useLanguage();
    const [hadith, setHadith] = useState<{ numberAr: string, numberEn: number, arabic: string } | null>(null);
    ...
    const [hadithNumberEn, setHadithNumberEn] = useState<number>(0);
    const [hadithNumberAr, setHadithNumberAr] = useState<string>("");
