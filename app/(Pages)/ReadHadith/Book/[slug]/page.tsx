...
import { useBookChapters } from "@/app/Hooks/ReadHadith/useBookChapters";
...
export default function BookChaptersPage() {
  ...
  const ErrorText: TranslationPair = {
    ar: "حدث خطأ أثناء تحميل الأبواب",
    en: "Error loading chapters",
  };

  const NoChapters: TranslationPair = {
    ar: "لا توجد أبواب",
                ...
                {chapters.length === 0 ? (
                  ...
                  <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-8">
                    {chapters.map((chapter) => (
                      <Link
                        key={chapter.id}
                        href={`/ReadHadith/Book/${bookSlug}/Chapter/${chapter.chapterNumber}`}
                        ...
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3 className="text-sm text-gray-500 dark:text-gray-400 mb-2">
                              {ChapterLabel[language]} {chapter.chapterNumber}
                            </h3>
                            {language === "ar" ? (
                              <p
                              dir="rtl"
