...
export default function Footer() {
  ...
  const firstText: TranslationPair = {
    en: "This website is designed as a continuous charity (Sadaqa Garya). I hope to make it easier for every muslim to get closer to Allah.",
    ar: "هذا الموقع مُصمم كصدقة جارية. آمل أن أجعل من السهل على كل مسلم أن يقترب من الله.",
  };
