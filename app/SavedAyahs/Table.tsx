...
export default function AyahsTable() {
  ...
  return (
    <div className="mt-32 max-w-screen-xl min-h-screen mx-auto px-4 md:px-8">
      ...
      <div className="mt-10 shadow-sm border border-teal-600 dark:border-white rounded-lg overflow-x-auto">
        <table className="w-full table-auto text-sm">
          <thead className="bg-teal-600 text-white font-medium border-b">
            <tr>
