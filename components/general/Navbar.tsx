...
export default function Navbar() {
  ...
  return (
    <div className="z-50 fixed flex w-full items-center justify-between px-4 py-3 bg-[#FFF5E4] text-teal-600 dark:bg-slate-900 dark:text-white shadow-md">
      ...
      <div className="flex items-center gap-2 relative">
        ...
        <Link
          ...
          className={`hidden md:flex items-center justify-center w-10 h-10 transition-colors duration-200 ${
            isActive("/saved-ayahs") ? "text-amber-600 dark:text-amber-400" : ""
          }`}
        >
        ...
        <Link
          href="/favourites"
          className={`hidden md:flex items-center justify-center w-10 h-10 transition-colors duration-200 ${
            isActive("/favourites") ? "text-amber-600 dark:text-amber-400" : ""
          }`}
        >
        ...
        <button
          ...
          className={`flex items-center justify-center w-10 h-10 transition-transform duration-700 md:hidden ${
      ...
      {isMobileMenuOpen && (
        <div
          className={`absolute top-16 px-5 py-2 border-b border-black dark:border-white left-0 w-full bg-[#FFF5E4] text-teal-600 dark:bg-slate-900 dark:text-white shadow-md md:hidden ${
